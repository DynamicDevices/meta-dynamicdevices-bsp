...
SRC_URI:append:imx8mm-jaguar-dt510 = " \
		...
		file://imx8mm-jaguar-dt510/0027-asoc-fsl-sai-sai5-capture-mirror-tx-frame.patch \
		${@('file://imx8mm-jaguar-dt510/pcm6240-lmp/0001-asoc-pcm6240-import-from-mainline-v6.10.patch file://imx8mm-jaguar-dt510/pcm6240-lmp/0002-asoc-pcm6240-optional-interrupt-dt510.patch file://imx8mm-jaguar-dt510/pcm6240-lmp/0003-asoc-pcm6240-capture-startup-pre-power-up.patch file://imx8mm-jaguar-dt510/pcm6240-audio-codec.cfg') if d.getVar('TAA5412_USE_PCM6240') == '1' else ''} \
