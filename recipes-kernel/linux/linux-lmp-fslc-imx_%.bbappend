...
SRC_URI:append:imx8mm-jaguar-dt510 = " \
		...
		${@('file://imx8mm-jaguar-dt510/pcm6240-lmp/0001-asoc-pcm6240-import-from-mainline-v6.10.patch file://imx8mm-jaguar-dt510/pcm6240-lmp/0002-asoc-pcm6240-optional-interrupt-dt510.patch file://imx8mm-jaguar-dt510/pcm6240-lmp/0003-asoc-pcm6240-capture-startup-pre-power-up.patch file://imx8mm-jaguar-dt510/pcm6240-lmp/0004-asoc-pcm6240-asi-tx-pasi0-on-capture.patch file://imx8mm-jaguar-dt510/pcm6240-lmp/0005-asoc-pcm6240-skip-pre-power-up-on-capture-startup.patch file://imx8mm-jaguar-dt510/pcm6240-lmp/0006-asoc-pcm6240-skip-capture-unmute-pre-power-up.patch file://imx8mm-jaguar-dt510/pcm6240-lmp/0007-asoc-pcm6240-restore-capture-unmute-pre-power-up.patch file://imx8mm-jaguar-dt510/pcm6240-lmp/0008-asoc-pcm6240-pre-power-before-asi-capture-startup.patch file://imx8mm-jaguar-dt510/pcm6240-lmp/0009-asoc-pcm6240-skip-pre-shutdown-module-param.patch file://imx8mm-jaguar-dt510/pcm6240-lmp/0010-asoc-pcm6240-warm-open-restore-ch1-digi.patch file://imx8mm-jaguar-dt510/pcm6240-audio-codec.cfg') if d.getVar('TAA5412_USE_PCM6240') == '1' else ''} \
		...
		${@('file://imx8mm-jaguar-dt510/tac5x1x-lmp/tac5x1x-lmp.cfg file://imx8mm-jaguar-dt510/tac5x1x-lmp/patches/01-tac5x1x-lore-263-2.patch file://imx8mm-jaguar-dt510/tac5x1x-lmp/patches/02-tac5x1x-lore-263-3.patch file://imx8mm-jaguar-dt510/tac5x1x-lmp/patches/03-tac5x1x-lore-263-4.patch file://imx8mm-jaguar-dt510/tac5x1x-lmp/patches/05-tac5x1x-lore-263-6.patch file://imx8mm-jaguar-dt510/tac5x1x-lmp/patches/06-tac5x1x-lore-263-7.patch file://imx8mm-jaguar-dt510/tac5x1x-lmp/patches/07-tac5x1x-lore-263-8.patch file://imx8mm-jaguar-dt510/tac5x1x-lmp/patches/07a-tac5x1x-fslc-codecs-makefile-objs.patch file://imx8mm-jaguar-dt510/tac5x1x-lmp/patches/07b-tac5x1x-fslc-codecs-makefile-obj.patch file://imx8mm-jaguar-dt510/tac5x1x-lmp/patches/08-tac5x1x-linux-6.6-fslc-compat.patch file://imx8mm-jaguar-dt510/tac5x1x-lmp/patches/09-tac5x1x-pinctrl-gpiochip-6.6-compat.patch file://imx8mm-jaguar-dt510/tac5x1x-lmp/patches/10-dt510-tac5301-analog-dt-defaults.patch file://imx8mm-jaguar-dt510/tac5x1x-lmp/patches/11-dt510-lore-skip-taa5412-match.patch') if d.getVar('TAC5X1X_USE_LORE_IKERNEL') == '1' else ''} \
		${@('file://imx8mm-jaguar-dt510/tac5x1x-lmp/tac5x1x-lmp-disable-ikernel.cfg') if d.getVar('TAC5X1X_USE_TI_OOT') == '1' else ''} \
		${@bb.utils.contains('MACHINE_FEATURES', 'bq25792-charger', 'file://imx8mm-jaguar-dt510/bq25792-charger.cfg file://imx8mm-jaguar-dt510/0010-mfd-bq257xx-add-bq25703a-core-fslc.patch file://imx8mm-jaguar-dt510/0011-power-supply-bq257xx-charger.patch file://imx8mm-jaguar-dt510/0012-regulator-bq257xx-boost-fslc.patch file://imx8mm-jaguar-dt510/0013-dt-bindings-mfd-ti-bq25703a-Import-binding-from-main.patch file://imx8mm-jaguar-dt510/0014-dt-bindings-mfd-ti-bq25703a-Expand-to-include-BQ2579.patch file://imx8mm-jaguar-dt510/0015-regulator-bq257xx-Remove-reference-to-the-parent-MFD.patch file://imx8mm-jaguar-dt510/0016-regulator-bq257xx-Drop-the-regulator_dev-from-the-dr.patch file://imx8mm-jaguar-dt510/0017-regulator-bq257xx-Make-OTG-enable-GPIO-really-option.patch file://imx8mm-jaguar-dt510/0018-power-supply-bq257xx-Fix-VSYSMIN-clamping-logic.patch file://imx8mm-jaguar-dt510/0019-power-supply-bq257xx-Make-the-default-current-limit-.patch file://imx8mm-jaguar-dt510/0020-power-supply-bq257xx-Consistently-use-indirect-get-s.patch file://imx8mm-jaguar-dt510/0021-power-supply-bq257xx-Add-fields-for-charging-and-ove.patch file://imx8mm-jaguar-dt510/0022-mfd-bq257xx-Add-BQ25792-support.patch file://imx8mm-jaguar-dt510/0023-regulator-bq257xx-Add-support-for-BQ25792.patch file://imx8mm-jaguar-dt510/0024-power-supply-bq257xx-Add-support-for-BQ25792.patch file://imx8mm-jaguar-dt510/0025-power-supply-bq257xx-charger-fix-usb_types-for-kernel-6.6.patch file://imx8mm-jaguar-dt510/bq257xx-mfd-kconfig.cfg', '', d)} \
...
SRC_URI:append:imx8mm-jaguar-screen = " \
		...
		file://imx8mm-jaguar-screen/0004-drm-imx-adopt-firmware-active-display-pipeline.patch \
		...
		${@bb.utils.contains('DISTRO_FEATURES', 'android-container', 'file://imx8mm-jaguar-screen/android-container.cfg', '', d)} \
