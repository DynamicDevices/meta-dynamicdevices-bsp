SUMMARY = "XM125 Radar Monitor - Service Range Configuration Update v2.0.12"
...
# Version and source - Updated to v2.0.12 with 7.0m service range configuration
PV = "2.0.12"
SRCBRANCH = "main"
SRCREV = "7a664915f33c0532a1bdb1927e1fe63a9070f96d"
