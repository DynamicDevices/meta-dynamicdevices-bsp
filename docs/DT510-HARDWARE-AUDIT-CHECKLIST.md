...
| GNSS **NEO-M9V** | UART via **CP2102N** USB + GPIO reset (`gnss-res#`) | **validated (lab); regression open 2026-06-10** | **2026-05-05/18:** NMEA + NDTR **`/dev/gnss`** @ **38400**. **2026-06-10 (`.205`):** symlink OK, **no NMEA**, **TXD ~2.5 V** idle. **BSP (unpinned):** drop **`gnss-res-hog`**, **`gpio-line-names`** IO29, **`dt510-gnss-reset-pulse`** — userspace reset after next LmP OTA. Chain: NEO → CP2102N **`10c4:ea60`**. | C5 |
