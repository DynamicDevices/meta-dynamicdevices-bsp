...
**Do not** set both DTS **`GPIO_ACTIVE_LOW`** and **`LineSettings(active_low=True)`** (double invert — pressed/released swapped). **Retest** DI1–DI3 after LmP (DTS) + containers **`f4e1f61`** OTA.

### Lab verification (2026-05-19)

**Status: validated (lab)** — cab buttons in **NDTR** + **AVM** with libgpiod v2 **`get_value`**; fleet retest after **single invert** fix (**`f4e1f61`**, containers **≥415**).
