...
- **Userspace ALSA (2026‑05):** **`alsa-state`** installs **`/etc/asound.conf`** with **`tannoys`** + **`tannoy_slot2`/`slot3`** + **`tas6424-init`**. **`amixer -D tannoys`** **`Speaker Driver CH1`–`CH4`** = **passenger tannoy** levels (TI legacy names); **not** cab **driver** amp — driver is **TAS2563** / **`drivers`** / **`driver_speaker`**. Canonical reference: [`DT510-TAS6424-TANNOY-ALSA.md`](DT510-TAS6424-TANNOY-ALSA.md).
