...
See also: `imx8mm-jaguar-dt510.dts` (`ksz9896_rst` / PME / INTR comments), `docs/DT510-ETHERNET-KSZ9896.md` (PHY **`mdio`** vs **`phytool`** on target), and Foundries bring-up `meta-subscriber-overrides/docs/DT510-HARDWARE-BRINGUP.md`.
