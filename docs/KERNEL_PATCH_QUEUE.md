...
| **`tas6424`** | `imx8mm-jaguar-dt510/tas6424-audio-codec.cfg`, **`0026-asoc-tas6424-rename-passenger-tannoy-controls.patch`** | TAS6424 class-D; ALSA **Tannoy CH1–CH4** mixer names (DT510) | Upstream renames or product accepts TI **Speaker Driver CHn** strings |
